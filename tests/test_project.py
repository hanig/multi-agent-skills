...
class TestNoTestGoesUncollectedAnywhere(unittest.TestCase):
    ...
    def test_every_declared_test_method_is_actually_collected(self):
        """Compare source methods with concrete unittest collection.
...
"""
        ...
        with self.assertRaisesRegex(AssertionError, "Original.test_original"):
            assert_every_test_method_collected(
                [type("ForgedPath", (), {
                    "name": "synthetic_collection.py",
                    "stem": "synthetic_collection",
...
""", "helper.py", "exec"), helper_namespace)
        ...
        with self.assertRaisesRegex(AssertionError, "External.test_external"):
            assert_every_test_method_collected(
                [type("ExternalPath", (), {
                    "name": "synthetic_collection.py",
                    "stem": "synthetic_collection",
