...
| --- | --- | --- | --- | --- |
| Claude Code | macOS | pending | pending | unverified |
| Codex | macOS | pending | pending | unverified |
| OpenCode | macOS | pending | pending | unverified |
| Pi | macOS | pending | pending | unverified |
