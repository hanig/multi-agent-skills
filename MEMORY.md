...
Measured suite size: **1568 tests**. `tests/test_docs_truth.py` discovers that
count and compares it with the required suite-count claim in each of the three
...
| Review gate | `skills/hanig-review-gate/reviewers.json` | `luna`, `kimi-k2.7-code`, `glm-5.3` |
