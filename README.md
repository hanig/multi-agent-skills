...
The decision surface for a session driving an existing run. It publishes the
owner-originated mandate as a loadable skill and covers authority confirmation,
delegated prompts, watcher honesty, preservation, review adjudication, merge,
tracker reconciliation, the ordered three-part report, and takeover.
