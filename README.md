...
| `deep` | `luna`, `kimi-k2.7-code`, `astra`, `glm-5.3` | reached only via `--escalate`; disabled reviewers do not run |
...
Full suite: 1580 tests, standard library only; no network or cluster required.

Green on macOS 3.10.16 and on all three clusters (3.10.12, 3.12.3, 3.10.12).

| file | lines | classes |
|---|---|---|
| `test_contract.py` | 2077 | 28 |
| `test_outbox.py` | 3108 | 41 |
